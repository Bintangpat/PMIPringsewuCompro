...
const TESTIMONIALS_DATA = [
  {
    quote:
      "Pelatihan First Aid di PMI memberikan saya kepercayaan diri untuk bertindak saat darurat. Seminggu setelah pelatihan, saya berhasil membantu rekan kerja yang pingsan berkat ilmu yang saya dapatkan.",
    name: "Alice Johnson",
  ...
  {
    quote:
      "Kurikulumnya sangat praktis dan mudah dipahami bahkan untuk pemula seperti saya.",
    name: "Daniel Lee",
    role: "Mahasiswa",
    image:
    ...
    <div className="bg-[#f8f9ff] text-[#0b1c30] selection:bg-[#ffdada] selection:text-[#b80035] min-h-screen">
      ...
      <header className="relative pt-32 pb-24 md:pt-48 md:pb-40 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 text-center md:text-left">
          ...
          >
            <motion.span
              variants={fadeUp}
              className="inline-block bg-[#b80035]/20 text-[#ffdada] border border-[#b80035]/30 px-4 py-1.5 rounded-full text-xs font-bold mb-6 uppercase tracking-widest backdrop-blur-sm"
            >
            ...
            <motion.p
              variants={fadeUp}
              className="text-lg text-white/80 mb-10 leading-relaxed font-medium"
            >
              Meningkatkan kesiapsiagaan dan keahlian kemanusiaan melalui
              pelatihan bersertifikasi standar internasional untuk individu
              maupun organisasi mitra.
            </motion.p>
            <motion.div
              variants={fadeUp}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          >
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-4">Pelatihan Individu</h3>
              <p className="text-[#5c5f61] mb-8 leading-relaxed">
                Program terbuka untuk masyarakat umum yang ingin memiliki
                keahlian dasar hingga tingkat lanjut dalam bidang pertolongan
                pertama, penanggulangan bencana, dan kerelawanan.
              </p>
              <a
                className="inline-flex items-center gap-2 text-[#b80035] font-bold group-hover:gap-3 transition-all"
                href="#"
              >
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-4">Pelatihan Mitra</h3>
              <p className="text-[#5c5f61] mb-8 leading-relaxed">
                Solusi pelatihan khusus untuk perusahaan, instansi pemerintah,
                dan organisasi sosial guna meningkatkan standar K3 dan
                kesiapsiagaan darurat di lingkungan kerja.
              </p>
              <a
                className="inline-flex items-center gap-2 text-[#b80035] font-bold group-hover:gap-3 transition-all"
                href="#"
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            ...
            >
              ...
              <p className="text-[#5c5f61] text-lg font-medium">
                Pelatihan yang Sedang Berlangsung & Akan Datang
              </p>
            </motion.div>
          ...
          >
            <table className="w-full text-left border-collapse min-w-[800px]">
              <thead className="bg-[#f8f9ff] text-[#0b1c30] border-b border-slate-100">
                <tr>
                  <th className="px-8 py-5 font-bold text-sm tracking-wide uppercase">
                    No
                  </th>
                  <th className="px-8 py-5 font-bold text-sm tracking-wide uppercase">
                    Nama Pelatihan
                  ...
                  <th className="px-8 py-5 font-bold text-sm tracking-wide uppercase text-right">
                    Aksi
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                {SCHEDULE_DATA.map((row) => (
                  ...
                  >
                    <td className="px-8 py-6 text-sm text-[#5c5f61] font-semibold">
                      {row.id}
                    </td>
                    <td className="px-8 py-6 font-bold text-[#0b1c30]">
                      {row.name}
                    </td>
                    <td className="px-8 py-6">
                      <span
                        className={`px-3 py-1.5 rounded-full text-xs font-bold ${
                          row.category === "Individu"
                    ...
                    <td className="px-8 py-6 text-sm text-[#5c5f61] font-medium">
                      {row.location}
                    </td>
                    <td className="px-8 py-6">
                      <span
                      ...
                      >
                        {row.status !== "Penuh" && (
                          <span className="w-2 h-2 bg-[#b80035] rounded-full animate-pulse" />
                        )}
                        {row.status}
                      </span>
                    </td>
      ...
      <section className="py-24 bg-[#213145] text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-[#cbdbf5] text-lg font-medium">
              Dengar langsung dari mereka yang telah bergabung bersama kami
            </p>
          </motion.div>
            ...
            {TESTIMONIALS_DATA.map((t, idx) => (
              ...
              >
                <div>
                  ...
                  <p
                    className={`italic mb-10 text-[#f8f9ff] leading-relaxed ${t.size === "large" ? "text-xl md:text-2xl font-semibold" : "text-base font-medium"}`}
                  >
                    "{t.quote}"
                  </p>
                </div>
                <div className="flex items-center gap-4 mt-auto">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#cbdbf5] font-medium">
                      {t.role}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-16 gap-y-10 opacity-60 grayscale hover:grayscale-0 transition-all duration-700">
            {PARTNERS.map((partner) => (
              <span
                key={partner}
                className="text-2xl text-[#5c5f61] font-extrabold tracking-tight"
              >
                {partner}
              </span>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-[#ffdada] text-lg mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
              Bergabunglah dengan ribuan alumni kami dan jadilah bagian dari
              solusi kemanusiaan di Indonesia.
            </p>
      ...
      <footer className="bg-[#111c2d] py-20 px-6 md:px-8 flex flex-col items-center gap-8 text-center border-t border-[#0b1c30]">
        <div className="flex flex-col items-center gap-4 mb-8">
          <span className="text-2xl font-black text-[#ffb3b6] tracking-tight">
            PMI Training Center
          </span>
          <p className="text-[#cbdbf5] max-w-md text-sm leading-relaxed font-medium">
            Menyelenggarakan pelatihan berkualitas untuk mencetak insan
            kemanusiaan yang tangguh dan profesional di seluruh Indonesia.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-8">
          {[
            ...
            <a
              key={link}
              className="text-[#cbdbf5] hover:text-white transition-colors font-medium text-sm underline underline-offset-4 decoration-[#cbdbf5]/30 hover:decoration-white"
              href="#"
            >
              {link}
            </a>
        ...
        <div className="flex gap-6 mb-8">
          <a
            href="#"
            className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-[#cbdbf5] hover:bg-[#b80035] hover:text-white transition-all"
          >
