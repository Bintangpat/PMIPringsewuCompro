        ...
        <section className="relative h-161 flex items-center justify-center text-center text-white px-6 overflow-hidden">
          ...
          >
            ...
            >
              ...
              jiwa dan meringankan penderitaan masyarakat yang terdampak bencana
            ...
            >
              <motion.div variants={fadeUpVariant} className="space-y-6">
                ...
                <p className="text-lg text-slate-600 leading-relaxed font-medium">
                  Indonesia terletak di wilayah "Ring of Fire", menjadikannya
                  salah satu negara yang paling rentan terhadap bencana alam.
                  Kesiapsiagaan dan kecepatan respon adalah kunci utama dalam
                  meminimalisir dampak kerugian jiwa dan materi.
                </p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Penyediaan kebutuhan dasar seperti pangan, air bersih, dan
                    shelter darurat segera setelah bencana terjadi.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Tim medis dan ambulans yang siaga 24/7 untuk evakuasi dan
                    perawatan darurat di lokasi terdampak.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Membantu mempertemukan kembali anggota keluarga yang
                    terpisah akibat situasi darurat bencana.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Pendampingan trauma healing bagi penyintas bencana, terutama
