        ...
        <section className="py-24 max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto leading-relaxed">
              Bergabung dengan PMI bukan hanya tentang memberi, tapi juga
              tentang tumbuh dan bertransformasi menjadi pribadi yang lebih
              tangguh.
            </p>
          </div>
          ...
          >
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  Bertemu dengan orang-orang hebat yang memiliki visi
                  kemanusiaan yang sama dengan Anda.
                </p>
              </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="p-8 flex-grow flex flex-col">
                  ...
                  <p className="text-sm text-slate-500 mb-8 line-clamp-3 leading-relaxed">
                    Bukan hal yang mudah melihat rumah-rumah runtuh, tapi
                    melihat anak-anak mulai bisa tertawa lagi di tenda
                    pengungsian adalah...
                  </p>
                  <div className="mt-auto flex items-center gap-4 pt-6 border-t border-slate-100">
                    <div className="w-12 h-12 rounded-full bg-slate-200 overflow-hidden">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                ...
                Anda yang ingin berkontribusi. Bergabunglah dengan keluarga
                besar kami hari ini.
              </p>
