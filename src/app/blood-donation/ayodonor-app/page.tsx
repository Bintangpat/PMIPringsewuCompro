    ...
    <main className="pt-24 pb-20 px-4 md:px-8 max-w-7xl mx-auto selection:bg-rose-200 selection:text-rose-900">
      ...
      <section className="relative overflow-hidden bg-white px-8 py-20 lg:py-32 border-b border-slate-100">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-2 bg-rose-50 text-rose-600 px-4 py-2.5 rounded-full text-xs font-bold uppercase tracking-widest shadow-sm"
            >
            ...
            <motion.h1
              variants={fadeUp}
              className="text-4xl md:text-5xl lg:text-[56px] font-extrabold text-slate-900 leading-[1.15] tracking-tight"
            >
              Menjadi Pahlawan{" "}
              <span className="text-rose-600">Kemanusiaan</span> dalam Satu
              Genggaman.
            </motion.h1>
            ...
            >
              Cek jadwal donor darah, cari stok darah terdekat, dan pantau
              riwayat donor Anda dengan mudah melalui aplikasi Ayo Donor.
            </motion.p>
            ...
            >
              <a
                href="#"
                className="flex items-center justify-center gap-3 bg-slate-900 text-white px-8 py-4 rounded-xl hover:bg-slate-800 transition-all active:scale-95 shadow-lg group"
              >
                <Apple className="w-8 h-8 fill-current" />
                <div className="text-left">
                  <div className="text-[10px] uppercase font-bold opacity-70 leading-none mb-1">
                    Download on the
                  </div>
                  <div className="text-lg font-boldleading-none">App Store</div>
                </div>
              </a>
              <a
                href="#"
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-lg font-boldleading-none">
                    Google Play
                  </div>
                </div>
              </a>
            ...
            <motion.div
              variants={fadeUp}
              className="flex items-center gap-6 pt-10 border-t border-slate-100"
            >
              <div className="flex -space-x-3">
                ...
                <img
                  ...
                  className="w-12 h-12 rounded-full border-4 border-white object-cover shadow-sm"
                />
                <div className="w-12 h-12 rounded-full border-4 border-white bg-rose-100 text-rose-600 flex items-center justify-center font-bold text-xs z-10 shadow-sm">
                  +50k
                </div>
              </div>
              ...
              <div className="w-full h-full bg-[#f8f9ff] pt-12 px-5 space-y-5 flex flex-col relative z-10">
                ...
                <div className="bg-rose-600 p-5 rounded-2xl text-white shadow-xl shadow-rose-200 space-y-2 relative overflow-hidden">
                  ...
                  <div className="flex justify-between items-end">
                    <span className="text-5xl font-blacktracking-tighter">
                      B+
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div
                      key={idx}
                      className="bg-white p-3.5 rounded-xl border border-slate-100 text-center shadow-sm flex flex-col items-center justify-center gap-2 hover:border-rose-200 transition-colors"
                    >
      ...
      <section className="max-w-7xl mx-auto px-8 py-24">
        ...
        >
          ...
          >
            Kami merancang setiap fitur untuk memudahkan langkah mulia Anda
        ...
        >
          ...
          <motion.div
            variants={fadeUp}
            className="md:col-span-2 bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:border-rose-200 transition-all duration-300 group overflow-hidden relative min-h-[300px] flex items-center"
          >
            <div className="relative z-10 max-w-sm">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4 tracking-tight">
                Pencarian Stok Darah Real-time
              </h3>
              <p className="text-slate-500 font-medium leading-relaxed">
                Cek ketersediaan kantong darah berdasarkan golongan dan lokasi
                di seluruh Unit Donor Darah PMI secara instan.
              </p>
            </div>
          ...
          <motion.div
            variants={fadeUp}
            className="bg-rose-50/50 p-10 rounded-[2.5rem] border border-rose-100/50 shadow-sm hover:shadow-md hover:bg-rose-50 transition-all duration-300 group"
          >
            ...
            <p className="text-slate-500 text-sm font-medium leading-relaxed">
              Jangan pernah melewatkan kesempatan donor lagi. Dapatkan
              notifikasi saat tubuh Anda sudah siap untuk mendonorkan kembali.
            </p>
          </motion.div>
          ...
          <motion.div
            variants={fadeUp}
            className="bg-slate-900 p-10 rounded-[2.5rem] text-white shadow-xl shadow-slate-900/10 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group"
          >
            ...
            <p className="text-slate-300 text-sm font-medium leading-relaxed">
              Kartu donor digital yang praktis, menggantikan kartu fisik. Cukup
              tunjukkan QR Code saat registrasi di lokasi.
            </p>
          </motion.div>
          ...
          <motion.div
            variants={fadeUp}
            className="md:col-span-2 bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:border-rose-200 transition-all duration-300 flex flex-col md:flex-row gap-10 items-center group"
          >
            <div className="flex-1">
              ...
              <p className="text-slate-500 font-medium leading-relaxed">
                Lihat peringkat donor di Hall of Fame dan dapatkan lencana
                eksklusif sebagai bentuk apresiasi atas kepedulian Anda.
              </p>
            </div>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
            <div className="max-w-2xl text-center lg:text-left space-y-6">
              <h2 className="text-4xl md:text-5xl font-extraboldleading-[1.15] tracking-tight">
                Unduh Aplikasi Ayo Donor Sekarang
              </h2>
              <p className="text-rose-100 text-lg font-medium leading-relaxed">
                Mulai langkah kecilmu untuk memberikan harapan besar bagi mereka
                yang membutuhkan. Tersedia gratis di App Store dan Google Play.
              </p>
              <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-6">
                <a
                  href="#"
                  className="bg-white text-slate-900 px-8 py-4 rounded-xl font-bold flex items-center gap-3 hover:bg-slate-50 transition-all active:scale-95 shadow-lg"
                >
                ...
                <a
                  href="#"
                  className="bg-slate-900 text-white px-8 py-4 rounded-xl font-bold flex items-center gap-3 hover:bg-slate-800 transition-all active:scale-95 shadow-lg border border-slate-700"
                >
                ...
                <div className="bg-white p-3 rounded-2xl w-32 h-32 mx-auto shadow-sm">
                  ...
                  <div className="w-full h-full grid grid-cols-4 grid-rows-4 gap-1 p-1">
                    {Array.from({ length: 16 }).map((_, i) => (
                      <div
                        key={i}
                        className={`bg-slate-900 rounded-sm ${Math.random() > 0.5 ? "opacity-100" : "opacity-0"}`}
                      />
                    ))}
                  </div>
                </div>
                ...
                <div className="bg-white p-3 rounded-2xl w-32 h-32 mx-auto shadow-sm">
                  ...
                  <div className="w-full h-full grid grid-cols-4 grid-rows-4 gap-1 p-1">
                    {Array.from({ length: 16 }).map((_, i) => (
                      <div
                        key={i}
                        className={`bg-slate-900 rounded-sm ${Math.random() > 0.3 ? "opacity-100" : "opacity-0"}`}
                      />
                    ))}
                  </div>
                </div>
